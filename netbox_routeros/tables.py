...
from netbox_routeros.template_code import TEMPLATE_LINK, TEMPLATE_BUTTONS, CONFIGURED_DEVICE_LINK, \
    CONFIGURED_DEVICE_BUTTONS
from netbox_routeros.utilities.tables import TagColumn
from tenancy.tables import COL_TENANT
from utilities.tables import (
    BaseTable, ToggleColumn, )
...
class ConfiguredDeviceTable(BaseTable):
    ...
    primary_ip4 = Column(
        linkify=True,
        accessor="device.primary_ip4",
        verbose_name='IPv4 Address'
    )
    primary_ip6 = Column(
        linkify=True,
        accessor="device.primary_ip6",
        verbose_name='IPv6 Address'
    )
    tags = TagColumn(
        accessor="device.tags",
    ...
    class Meta(BaseTable.Meta):
        ...
        fields = ('pk', 'name', 'primary_ip4', 'primary_ip6', 'tags', 'last_config_fetched_at', 'last_config_pushed_at', 'actions')
        default_columns = ('name', 'slug', 'primary_ip4', 'primary_ip6', 'tags', 'last_config_fetched_at', 'last_config_pushed_at', 'actions')
