...
from netbox_routeros.utilities import TagColumn
...
class ConfiguredDeviceTable(BaseTable):
    ...
    class Meta(BaseTable.Meta):
        ...
        fields = ('pk', 'name', 'primary_ip4', 'primary_ip6', 'tags', 'actions')
        default_columns = ('name', 'slug', 'primary_ip4', 'primary_ip6', 'tags', 'actions')
